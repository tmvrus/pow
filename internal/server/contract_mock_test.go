...
//
//	mockgen -source=contract.go -destination=./contract_mock_test.go -package=server
//
...
// NewSessionHandler mocks base method.
func (m *MocksessionFactory) NewSessionHandler() api.SessionHandler {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewSessionHandler")
	ret0, _ := ret[0].(api.SessionHandler)
	return ret0
}

// NewSessionHandler indicates an expected call of NewSessionHandler.
func (mr *MocksessionFactoryMockRecorder) NewSessionHandler() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NewSessionHandler", reflect.TypeOf((*MocksessionFactory)(nil).NewSessionHandler))
}
